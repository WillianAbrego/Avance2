...
contenedor[0] += '<br/><br/>';
contenedor[0] += 'Poblacion 319,503  hab.</div><div class="post">';
...
contenedor[1] += '<br/><br/>';
contenedor[1] += 'Poblacion 438.960 hab.</div><div class="post">';
...
contenedor[4] += '<br/><br/>';
contenedor[4] += 'Poblacion: 21.102</div><div class="post">';
...
contenedor[6] += '<br/><br/>';
contenedor[6] += 'Poblacion 53.213 (2012) </div><div class="post">';
...
contenedor[8] += '<br/><br/>';
contenedor[8] += '29 733 hab.(2012)</div><div class="post">';
...
contactanos+= '<h4>Nombre completo:<h4>  <input type="text" id="nombre" value="" pattern="^[a-zA-Z\s]+$" title="Solo se aceptan letras" class="control" placeholder="Nombre" required/><br>'
contactanos+='<h4>Correo Electronico:<h4> <input id="input" type="email" id="correo" value="" title="Formato de correo: NombreCorreo@dominio" class="control" placeholder="Correo Electronico" required/><br>'       
contactanos+='<h4>Escribenos tu comentario:<h4> :<input id="coment" type="text" id="nombre" value="" pattern="^[a-zA-Z\s]+$" title="Solo se aceptan letras" class="control" required maxlength="700" minlength="20" >'
contactanos+='<h4><h4>  <button id="boton" type="submit"> Enviar </button>'
